...
function init(): void {
    ...
    async function loadArtikel(): Promise<Response> {

        let response: Response = await fetch("file:///C:/Users/SAAAAAAAAmm/Documents/GIS/Aufgabe6/Artikel.JSON");
        return response;
    ...
    let jsonString = JSON.stringify(loadArtikel());
...
function sortDisplay(_article: Product[], _name: string): void {
    document.getElementsByClassName("wrapper")[0].innerHTML = "";
